...
aggregateObservationFlag("", "T", flagTable = flagWeightTable)
@
...
simulatedProductionFlag =
    flagWeightTable[sample(1:NROW(flagWeightTable), 10, replace = TRUE),
